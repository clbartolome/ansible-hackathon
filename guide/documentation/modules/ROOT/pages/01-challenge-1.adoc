...
** Utiizar credenciales proporcionados en AAP - [5 puntos]
** Utilizar inventario ``Windows`` proporcionado en AAP - [5 puntos]
* Mostrar en la ejecucion del playbook los ficheros ``.sys`` dentro de la carpeta ``Crowdstrike`` - [5 puntos]
* Mostrar en la ejecucion del playbook los ficheros ``.sys`` dentro de la carpeta ``Crowdstrike`` junto con su fecha de creación - [10 puntos]
* Utilizar un diccionario para la ejecucion del reto - [20 puntos]
* Borrar el fichero - [20 puntos]
* Utilizar la colección ansible.windows - [10 puntos]
